...
class TestAufgabe4
{
    ...
    void runMethodUnderTest(int limit) throws ClassNotFoundException
    {
        ...
        invokeMethod(myClass, getMethod(myClass, "aufgabe4",int.class),limit);
    ...
    void runExpectedMethod(int limit)
    {
        ...
        src.x09p03.AufgabeMock.aufgabe4(limit);
    ...
    @Test
    @StrictTimeout(1)
    void testAufgabe4_lineCount1()
    {
        helper_lineCount();
    }
    @Test
    @StrictTimeout(1)
    void testAufgabe4_exactMatch1()
    {
        helper_exactMatch();
    }
    @Test
    @StrictTimeout(1)
    void testAufgabe4_lineCount2()
    {
        helper_lineCount();
    }
    @Test
    @StrictTimeout(1)
    void testAufgabe4_exactMatch2()
    {
        helper_exactMatch();
    }
    @Test
    @StrictTimeout(1)
    void testAufgabe4_lineCount3()
    {
        helper_lineCount();
    }
    @Test
    @StrictTimeout(1)
    void testAufgabe4_exactMatch3()
    {
        helper_exactMatch();
    }
